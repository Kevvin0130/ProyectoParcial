...
fun CasosScreen(
    ...
    val casos by viewModel.casosFiltrados.collectAsState()
    ...
    Column(
        ...
        Text("Mis casos", style = MaterialTheme.typography.headlineSmall)

        OutlinedTextField(
            value = busqueda,
            onValueChange = { viewModel.actualizarBusqueda(it) },
            leadingIcon = { Icon(Icons.Default.Search, contentDescription = null) },
            label = { Text("Buscar por titulo o descripcion") },
            singleLine = true,
